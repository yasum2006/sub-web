    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "subcon-yasum.vercel.app": "https://subcon-yasum.vercel.app?",
        ...
        remoteConfig: [
          ...
          },
          {
            ...
            options: [
              {
                label: "ACL4SSR_Online_ding修改媒体版(与Github同步)",
                value:
              ...
              },
              {
                ...
                value:
                  "https://raw.githubusercontent.com/yasum2006/ACL4SSR/master/Clash/config/ACL4SSR_Online_ding.ini"
              },
              {
